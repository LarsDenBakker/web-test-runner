...
const runnerHtml = fs.readFileSync(new URL('../runtime/web-test-runner.html', import.meta.url), 'utf-8');
const runnerJs = fs.readFileSync(new URL('../runtime/web-test-runner-suite.js', import.meta.url), 'utf-8');
export function createEsDevServer() {
                        ...
                        if (url === '/' || url.startsWith('/?file')) {
                            return {
                                ...
                                body: process.env.LOCAL_TESTING
                                    ? runnerHtml.replace('import { runTests } from "web-test-runner";', 'import { runTests } from "./dist/runtime/web-test-runner.js";')
                                    : runnerHtml,
                            };
                        }
                    },
